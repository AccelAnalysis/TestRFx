...
const registry: Record<ExchangeLens, { own: ActionSpec[]; other: ActionSpec[] }> = {
  rfx: { own: [
    ...
    { id: "manage-rfx", label: "Manage", icon: "✎", trigger: "workflow", requiresRecord: true },
    { id: "invite-team", label: "Invite Team", icon: "◎", trigger: "workflow", requiresRecord: true },
    { id: "watch", label: "Watch", icon: "☆", trigger: "workflow", requiresRecord: true, toggle: "watch" },
  ], other: [
    { id: "view", label: "View Detail", icon: "◉", trigger: "workflow", requiresRecord: true },
  ...
  resources: { own: [
    { id: "offer-resource", label: "Offer", icon: "+", trigger: "workflow" },
    { id: "edit-resource", label: "Edit", icon: "✎", trigger: "workflow", requiresRecord: true },
    { id: "share", label: "Share", icon: "↗", trigger: "workflow", requiresRecord: true },
    { id: "save-archive-resource", label: "Save / Archive", icon: "▣", trigger: "workflow", requiresRecord: true },
  ], other: [
    { id: "request-resource", label: "Request", icon: "+", trigger: "workflow", requiresRecord: true },
    { id: "view", label: "View Detail", icon: "◉", trigger: "workflow", requiresRecord: true },
    { id: "share", label: "Share", icon: "↗", trigger: "workflow", requiresRecord: true },
    { id: "save", label: "Save", icon: "☆", trigger: "workflow", requiresRecord: true, toggle: "save" },
  ]},
  intelligence: { own: [
    { id: "add-insight", label: "Add Insight", icon: "+", trigger: "workflow" },
    { id: "edit-insight", label: "Edit Insight", icon: "✎", trigger: "workflow", requiresRecord: true },
    { id: "compare", label: "Compare", icon: "⇄", trigger: "workflow", requiresRecord: true },
    { id: "track", label: "Track", icon: "☆", trigger: "workflow", requiresRecord: true, toggle: "track" },
  ], other: [
    { id: "view", label: "View Detail", icon: "◉", trigger: "workflow", requiresRecord: true },
    { id: "add-note", label: "Add Note", icon: "◌", trigger: "workflow", requiresRecord: true },
    { id: "compare", label: "Compare", icon: "⇄", trigger: "workflow", requiresRecord: true },
    { id: "follow-track", label: "Follow / Track", icon: "☆", trigger: "workflow", requiresRecord: true, toggle: "follow" },
  ]},
  capabilities: { own: [
    ...
    { id: "view", label: "View Capabilities", icon: "◉", trigger: "workflow", requiresRecord: true },
    ...
    { id: "follow", label: "Save / Follow", icon: "☆", trigger: "workflow", requiresRecord: true, toggle: "follow" },
  ]},
};
...
function toAction(spec: ActionSpec, position: 1 | 2 | 3 | 4, ownership: LensActionOwnership, record?: ExchangeRecord): LensAction {
  ...
  return {
    id: spec.id, position, label: spec.label, icon: spec.icon, trigger: spec.trigger, ownership,
    visible: true, applicable, authorized: true, operational: spec.operational ?? true,
    prerequisitesSatisfied: true, requiresRecord: spec.requiresRecord, toggle: spec.toggle,
