...
// This tree intentionally mirrors the Resources source. It does not add
// categories or workflow branches that are not present in that source.
export const resourceNavigationTree: ResourceNavigationNode[] = [
  {
    id: "own-view",
    label: "My Organization’s Resources",
    audience: "own",
    children: [
      {
        id: "offer-resource",
        ...
        audience: "own",
        children: [
          { id: "offer-resource-modal", label: "Offer Resource modal", audience: "own", action: "offer" },
        ],
      },
      {
        id: "edit-resource",
        ...
        requiresRecord: true,
        children: [
          { id: "manage-edit-resource", label: "Manage / Edit Resource", audience: "own", requiresRecord: true, action: "edit" },
        ],
      },
      {
        id: "share-own",
        ...
        requiresRecord: true,
        children: [
          { id: "share-menu-send-resource", label: "Share menu / send resource", audience: "own", requiresRecord: true, action: "share" },
        ],
      },
      {
        id: "save-archive",
        ...
        requiresRecord: true,
        children: [
          { id: "save-or-archive-action", label: "Save or Archive action", audience: "own", requiresRecord: true, action: "save-archive" },
        ],
      },
    ],
  },
  {
    id: "others-view",
    label: "Resources from Other Organizations",
    audience: "other",
    children: [
      {
        id: "request-resource",
        ...
        requiresRecord: true,
        children: [
          { id: "request-resource-modal", label: "Request Resource modal", audience: "other", requiresRecord: true, action: "request" },
        ],
      },
      {
        ...
        requiresRecord: true,
        children: [
          { id: "resource-detail-view", label: "Resource detail view", audience: "other", requiresRecord: true, action: "view" },
        ],
      },
      {
        id: "share-other",
        ...
        requiresRecord: true,
        children: [
          { id: "share-menu-send-organization", label: "Share menu / send to another organization", audience: "other", requiresRecord: true, action: "share" },
        ],
      },
      {
        id: "save-other",
        ...
        requiresRecord: true,
        children: [
          { id: "save-follow-action", label: "Save / follow action", audience: "other", requiresRecord: true, action: "save-follow" },
        ],
      },
    ],
  },
  {
    id: "cross-lens-referral",
    label: "Cross-lens Referral Workflow",
    audience: "any",
    children: [
      {
        id: "refer-from-resource",
            ...
            children: [
              {
                ...
                children: [
                  {
                    id: "track-referrals-management",
                    label: "Track in Menu → Referrals Management",
                    audience: "any",
                    action: "open-referrals-management",
                  },
                ],
              },
            ],
...
export function resourceNavigationChildren(state: ResourceNavigationState) {
  return childrenAtPath(state.path);
}
