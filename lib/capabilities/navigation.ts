    ...
    children: [{
      ...
      children: [{
        ...
        children: [{
          ...
          children: [{
            id: "capability-gaps", label: "Identify Capability Gaps", description: "Review explicit profile and requirement gaps.", scope: "own",
            children: [{
...
const otherBranch: CapabilityNavigationNode = {
  ...
  children: [{
    ...
    children: [{
      ...
      children: [{
        id: "match-rfx", label: "Match to RFx / requirement", description: "Use the shared governed matching boundary against structured RFx requirements.", scope: "other", requiresSelectedOther: true,
        children: [{
          ...
          children: [
            { id: "refer", label: "Refer", description: "Create a cross-lens referral for the selected organization.", scope: "other", requiresSelectedOther: true, children: [{ id: "cross-lens-referral", label: "Cross-lens referral workflow", description: "Continue the referral through the shared workflow service.", scope: "other", requiresSelectedOther: true }] },
            { id: "save-follow", label: "Save / Follow", description: "Persist the shared Exchange relationship.", scope: "other", requiresSelectedOther: true, children: [{ id: "saved-organizations", label: "Watchlist / saved organizations", description: "Open the shared Saved & Watchlist management surface.", scope: "other" }] },
            { id: "open-detail", label: "Open detail", description: "Open the shared detail controller for the selected capability profile.", scope: "other", requiresSelectedOther: true, children: [{ id: "capability-detail", label: "Capability detail / supporting evidence", description: "Inspect claims, AMACS alignment, and supporting evidence.", scope: "other", requiresSelectedOther: true }] },
          ],
        }],
      }],
    }],
...
export function capabilityNavigationPath(target: CapabilityNavigationNodeId, node: CapabilityNavigationNode = capabilityNavigationTree, path: CapabilityNavigationNodeId[] = []): CapabilityNavigationNodeId[] {
  ...
  for (const child of node.children ?? []) {
    const found = capabilityNavigationPath(target, child, nextPath);
