...
export function DetailSurface({ record, actions, activeActionIds, onAction, onClose }: { record: ExchangeRecord; actions: LensAction[]; activeActionIds?: string[]; onAction: (action: LensAction) => void; onClose: () => void; }) {
